...
link:automation-architect/maven.adoc[Maven,window=_blank]

Sure! When introducing Maven, you should cover the following key points:
...
link:automation-architect/rest-assured.adoc[Rest Assured,window=_blank]
